...
Aplicação desenvolvida para um desafio técnico, com cadastro, edição, listagem e visualização de chamados, além de atribuição manual ou automática de responsáveis.
